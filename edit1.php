...
$con=mysqli_connect("localhost","root","","project");
...

	{
    	...
    	$sqli="UPDATE department SET department_head='$newdepartment_head', teachers='$newteachers', no_of_courses='$newno_of_courses',total_credit='$newtotal_credit',no_of_lab='$newno_of_lab',budget='$newbudget' where department_name='$department_name'";
...
<form  method="post" action="edit1.php?department_name=<?php echo $_REQUEST['department_name']; ?>">
